...
const TitleNowPlaying = ({title,overview}) => {
  return (
    <div className='w-screen aspect-video pt-[5%] px-4 md:px-20 absolute text-white bg-gradient-to-r from-black'>
      ...
      <div className='mt-3'>
        <button className='bg-slate-500 ml-10 hover:bg-slate-400 text-white font-bold py-2 px-4 rounded-md'>Play Now</button>
        <button className='bg-slate-500 mx-3 hover:bg-slate-400 text-white font-bold py-2 px-4 rounded-md'>More Info</button>
      </div>
    </div>
  )
}
